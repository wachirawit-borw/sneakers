...
export default function Features() {
  ...
  return (
    <AnimateOnScroll>
      <section
        id="features"
        className="bg-gradient-to-r from-[#f0cca8] to-[#ccdef5] py-20 px-6 text-black text-center"
      >
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 justify-items-center">
          <Feature
            icon="🪶"
            title="Lightweight"
            text="Walk freely all day with ultra-light cushioning."
          />
          <Feature
            icon="⚡"
            title="Fast Shipping"
            text="Your order ships within 24 hours, guaranteed."
          />
          <Feature
            icon="🧍"
            title="Elegant Design"
            text="Minimal, bold and timeless — design with presence."
          />
        </div>
      </section>
    </AnimateOnScroll>
